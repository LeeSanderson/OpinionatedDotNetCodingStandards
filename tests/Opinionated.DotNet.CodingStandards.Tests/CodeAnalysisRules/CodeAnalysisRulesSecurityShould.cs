    ...
    : CodingStandardsTestBase(fixture, testOutputHelper)
{
    ...
    public async Task ProhibitBinaryFormatterUsage()
    {
        ...
        using var project = await CreateProjectBuilderAsync(properties: [(Name: "NoWarn", Value: "SYSLIB0011")]);
        await project.AddFileAsync(
            "Program.cs",
            """
    ...
    public async Task ProhibitSerializingTypesWithPointerFields()
    {
        ...
        using var project = await CreateProjectBuilderAsync(properties: [(Name: "AllowUnsafeBlocks", Value: "true")]);
        await project.AddFileAsync(
            "Program.cs",
            """
            namespace test;
    ...
    public async Task ProhibitObsoleteKeyDerivationFunction()
    {
        ...
        using var project = await CreateProjectBuilderAsync(properties: [(Name: "NoWarn", Value: "SYSLIB0041")]);
        await project.AddFileAsync(
            "Program.cs",
            """
            using System.Security.Cryptography;
    ...
    public async Task ProhibitWeakKeyDerivationFunctionWithInsufficientIterations()
    {
        ...
        using var project = await CreateProjectBuilderAsync(properties: [(Name: "NoWarn", Value: "SYSLIB0060")]);
        await project.AddFileAsync(
            "Program.cs",
            """
            using System.Security.Cryptography;
    ...
    public async Task EnsureJavaScriptSerializerNotInitializedWithSimpleTypeResolver()
    {
        ...
        using var project = await CreateProjectBuilderAsync(properties: [(Name: "NoWarn", Value: "IDE0130;SA1649;IDE0065")]);
        await project.AddFileAsync(
            "Program.cs",
            """
    ...
    public async Task ProhibitAddingSchemaByUrl()
    {
        ...
        using var project = await CreateProjectBuilderAsync(properties: [(Name: "NoWarn", Value: "CS0618")]);
        await project.AddFileAsync(
            "Program.cs",
            """
            using System.Xml.Schema;
