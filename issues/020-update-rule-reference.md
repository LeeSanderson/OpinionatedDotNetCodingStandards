...
- [ ] `docs/rule-reference.md` has been regenerated and the new rule IDs (MA0221, MA0222, MA0223,
      MA0224, MA0225) appear in it
...
All per-rule test issues for this PRD (issues 015 through 019).
